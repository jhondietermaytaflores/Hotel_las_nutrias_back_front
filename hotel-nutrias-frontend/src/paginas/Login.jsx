...
function Login() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#121212]  rounded-1xl border border-green-500/60 bg-gradient-to-tr from-[#0F0F0F] to-[#0B0B0B] text-white shadow-2xl shadow-green-500/10 backdrop-blur-xl p-8 relative overflow-hidden">
      <form onSubmit={handleLogin} className="bg-[#112426] p-8 rounded-3xl border border-green-600/80 shadow-lg w-96">
        ...
        <button
          type="submit"
          className="w-full px-4 py-3 tracking-wide text-white transition-colors duration-200 transform bg-gradient-to-r from-green-600 to-cyan-950 rounded-lg hover:from-green-700 hover:to-cyan-700 focus:outline-none focus:ring-4 focus:ring-green-400 dark:focus:ring-green-800"
        >
          Iniciar sesión
        </button>
      ...
      <Dialog open={modalAbierto} onClose={() => setModalAbierto(false)} className="relative z-50">
        ...
        {/* Panel del modal */}
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="w-[400px] rounded-3xl border border-green-500/20 bg-gradient-to-tr from-[#0F0F0F] to-[#0B0B0B] text-white shadow-2xl shadow-green-500/10 backdrop-blur-xl p-8 relative overflow-hidden">

            {/* Fondo animado */}
            <div className="absolute inset-0 z-0">
              <div className="absolute -bottom-20 -left-20 w-48 h-48 rounded-full bg-green-500/10 blur-3xl opacity-30 animate-pulse" />
            ...
            <div className="relative z-10">
              <Dialog.Title className="text-2xl font-bold text-green-400 mb-4 text-center">Login Facial</Dialog.Title>
          ...
          <div className="p-8 relative z-10">
            <div className="flex flex-col items-center text-center">
              <div className="relative mb-6">
                ...
                <div className="p-6 rounded-full backdrop-blur-lg border border-green-500/20 bg-gradient-to-br from-black/80 to-gray-900/60 shadow-2xl transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 hover:shadow-green-500/20">
                  <div className="transform group-hover:rotate-180 transition-transform duration-700">
                    <svg className="w-8 h-8 text-green-500 fill-current group-hover:text-green-400 transition-colors duration-300 filter drop-shadow-lg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
              ...
              <div className="space-y-1 max-w-sm">
                ...
                <button
                  onClick={() => setModalAbierto(true)}
                  className="inline-block w-full text-gray-970 border border-green-500 text-lg font-bold leading-relaxed transform group-hover:text-gray-200 transition-colors duration-300 "
                >
                  Iniciar
                </button>
              </div>
